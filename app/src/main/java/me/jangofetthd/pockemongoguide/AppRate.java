...
public class AppRate implements OnClickListener, OnCancelListener {
	...
	private void showDefaultDialog() {
		...
		String title = hostActivity.getString(R.string.AR_title);
		String message = hostActivity.getString(R.string.AR_message) + getApplicationName(hostActivity.getApplicationContext()) + hostActivity.getString(R.string.AR_message1);
		String rate = hostActivity.getString(R.string.AR_rate);
		String remindLater = hostActivity.getString(R.string.AR_later);
		String dismiss = hostActivity.getString(R.string.AR_dismiss);
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			try
			{
				...
				Toast.makeText(hostActivity, R.string.AR_PlayStoreNotInstalled, Toast.LENGTH_SHORT).show();
			}
